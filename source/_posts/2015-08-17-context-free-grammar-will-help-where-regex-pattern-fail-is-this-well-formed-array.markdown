...
###Why not regex ?
Let's simplified our example. Let's say that we want to write a regular expression which will generate following words w = {'['^n']'^n | n >= 1}
```
[]
[[]]
[[]]
